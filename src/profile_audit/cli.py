...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="github-proof", description="GitHubProof: audit a GitHub account's contribution reality and star patterns.")
    subparsers = parser.add_subparsers(dest="command", required=True)

    run_parser = subparsers.add_parser("run", help="Run an audit for one GitHub username.")
    run_parser.add_argument("--subject", required=True, help="GitHub username to audit.")
